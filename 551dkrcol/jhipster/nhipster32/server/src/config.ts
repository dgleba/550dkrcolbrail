...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'nhipster32';
    ...
    'jhipster.mail.from' = 'nhipster32@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nhipster32 API';
    'jhipster.swagger.description' = 'nhipster32 API documentation';
    ...
    'eureka.instance.appname' = 'nhipster32';
    'eureka.instance.instanceId' = 'nhipster32:${random.value}';
