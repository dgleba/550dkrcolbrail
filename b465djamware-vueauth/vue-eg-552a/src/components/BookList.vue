<template>
  <b-row>
    <b-col cols="12">
      ...
      <b-table striped hover :items="product_model" :product_model_fields="product_model_fields">
        <template slot="actions" scope="row">
          <b-btn size="sm" @click.stop="details(row.product.model)">Details</b-btn>
        </template>
      </b-table>
    </b-col>
  </b-row>
